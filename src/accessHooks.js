...
export const usePagedCustomerList = (initialPageSize, url="http://localhost:3081/app/books") => {
...
export const usePagedSearchCustomerList = (initialPageSize, query, url="http://localhost:3081/app/books") => {
    const [pageSize, setPageSize] = useState(initialPageSize);
    const [list, setList] = useState([]);
    const [location, setLocation] = useState(1);
    const [length, setLength] = useState(0);
...
export const deleteCustomer = async (id, login, url="http://localhost:3081/app/books") => {
...
export const updateCustomer = async (customer, login, url="http://localhost:3081/app/books") => {
...
export const addCustomer = async (customer, login, url="http://localhost:3081/app/books") => {
